...
//#region node_modules/.nitro/vite/services/ssr/assets/router-oTAGgjZz.js
...
var site = {
	...
	description: "Davit Simonyan, founder of Arag Agency. Inbox Autopilot turns email into actions. Tyoma reads a website, then talks."
};
var nav = [
	{
		href: "#work",
...
var projects = [{
	...
	status: "Live",
	year: "2026",
	summary: "The inbox is a pile of unstructured work. This system reads each message and decides what to do — extract, draft, or escalate — instead of leaving a human to sort the queue.",
	points: [
	...
	status: "Live",
	year: "2026",
	summary: "Paste a URL. In a few seconds you are chatting with an assistant that already read the site. No onboarding dump, no “here is our FAQ.” The context is the page itself. A live product from Arag Agency.",
	points: [
...
var styles_default = "/assets/styles-C9qWAob6.css";
var APP_NAME = site.title;
var Route$1 = createRootRoute({
	head: () => ({
		...
		links: [
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Sora:wght@400;500;600&display=swap"
			},
			{
				rel: "stylesheet",
				href: styles_default
...
var $$splitComponentImporter = () => import("./routes-BJLVmGQn.mjs");
...
//#endregion
export { site as a, projects as i, capabilities as n, stats as o, nav as r, steps as s, router_exports as t };
